...
function clearPerfValues() {
    $('#perf_fuel_flow_type').data('mode', 'combined');
    $('#perf_fuel_flow_type').text('Combined Fuel Flow');
    // Restore default input attributes for Combined
    $('#perf_fuel_flow').attr({ min: 2000, max: 24000, step: 1000 }).val('14000');
    $('#perf_afterburner').prop('checked', false)
